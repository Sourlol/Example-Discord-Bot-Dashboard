...
module.exports = client => {
    ...
    app.get("/dashboard/:guildID", checkAuth, async (req, res) => {
        ...
        if (!guild) return res.redirect("/?error=" + encodeURIComponent("I am not in this guild yet."));
        ...
        if (!member) return res.redirect("/?error=" + encodeURIComponent("Login first please!"));
